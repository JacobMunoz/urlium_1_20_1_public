...
public class ServerCommand2 {

    public static void register(CommandDispatcher<ServerCommandSource> dispatcher,
                                CommandRegistryAccess commandRegistryAccess,
                                CommandManager.RegistrationEnvironment registrationEnvironment) {
        dispatcher.register(
                (LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal(UrlComMod.getMessageCommand2Name())
                    .requires(source -> source.hasPermissionLevel(UrlComMod.messageCommand2Level)))
                    .then(
