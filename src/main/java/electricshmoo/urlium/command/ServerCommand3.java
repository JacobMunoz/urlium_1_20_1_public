...
public class ServerCommand3 {

    public static void register(CommandDispatcher<ServerCommandSource> dispatcher,
                                CommandRegistryAccess commandRegistryAccess,
                                CommandManager.RegistrationEnvironment registrationEnvironment) {
        dispatcher.register(
                (LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal(UrlComMod.getMessageCommand3Name())
                    .requires(source -> source.hasPermissionLevel(UrlComMod.messageCommand3Level)))
                    .then(
